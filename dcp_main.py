...
#2018.05.11. : 간만에 코드 다시 보니 모르겠다. (04.10.에 추가한 주문 체결을 정상 동작 확인함.
#               TODO: 1. blockrequest가 아닌 request로 event처리를 해서 데이터를 받는 것을 구현할 것.
#                     2. request의 제한 갯수에 대응하여 waiting timer를 적용하는 구조 구현할 것.
#                     3. buy뿐 아니라 sell도 구현할 것.
#                     4. 이번처럼 간만에 봐도 즉시 이해할 수 있도록 문서 작업을 해 놓을 것.
#               머랄까 매번 반복되는 것같은데 이런걸 방지하기 위해 어떻게 할지 고민 좀 하자.
#               했던 거 또 하는 것도 이젠 지겹거든....
